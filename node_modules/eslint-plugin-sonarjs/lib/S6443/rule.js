            ...
            [declarationSelector](node) {
                if (isReactCall(context, node.init)) {
                    ...
                    referencesBySetterName[setter] = {
                        setter: (0, helpers_1.getVariableFromName)(context, setter, node),
                        value: (0, helpers_1.getVariableFromName)(context, elements[0].name, node),
                    };
                }
            },
            [callSelector](node) {
                const setter = (0, helpers_1.getVariableFromName)(context, node.callee.name, node);
                const value = (0, helpers_1.getVariableFromName)(context, node.arguments[0].name, node);
