...
exports.rule = helpers_1.Express.SensitiveMiddlewarePropertyRule(findSensitiveTransportSecurityPolicyProperty, `Disabling Strict-Transport-Security policy is security-sensitive.`, (0, helpers_1.generateMeta)(meta_1.meta, undefined, true));
...
function findSensitiveMaxAge(context, middleware, options) {
    if (isHstsMiddlewareNode(context, middleware)) {
        const maybeMaxAgeProperty = (0, helpers_1.getProperty)(options, MAX_AGE, context);
