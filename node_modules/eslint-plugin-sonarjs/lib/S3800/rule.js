...
const isASanitationFunction = (signature) => {
    ...
    return types.length === 2 && types.some(helpers_1.isBooleanTrueType) && types.some(helpers_1.isStringType);
};
exports.rule = {
    ...
    create(context) {
        ...
        function onFunctionExit(node) {
            ...
            if (signature && hasMultipleReturnTypes(signature, checker)) {
                ...
                }, stmts.map((stmt, i) => (0, helpers_1.toSecondaryLocation)(stmt, `Returns ${prettyPrint(stmtsTypes[i], checker)}`)));
            }
        }
        return {
