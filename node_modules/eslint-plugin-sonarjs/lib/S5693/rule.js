...
function checkFormidable(context, callExpression) {
    ...
    if (options) {
        const property = (0, helpers_1.getProperty)(options, MAX_FILE_SIZE, context);
...
function checkMulter(context, callExpression) {
    ...
    const limitsPropertyValue = (0, helpers_1.getProperty)(multerOptions, LIMITS_OPTION, context)?.value;
    if (limitsPropertyValue && limitsPropertyValue.type === 'ObjectExpression') {
        const fileSizeProperty = (0, helpers_1.getProperty)(limitsPropertyValue, FILE_SIZE_OPTION, context);
...
function checkBodyParser(context, callExpression) {
    ...
    const limitsProperty = (0, helpers_1.getProperty)(options, LIMITS_OPTION, context);
