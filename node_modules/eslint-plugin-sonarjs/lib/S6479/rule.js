...
const baseRule = eslint_plugin_react_1.rules['no-array-index-key'];
exports.rule = (0, helpers_1.interceptReportForReact)({
    ...baseRule,
    meta: (0, helpers_1.generateMeta)(meta_1.meta, baseRule.meta),
