 ...
 */
const preferOptionalChainRule = typescript_eslint_1.tsEslintRules['prefer-optional-chain'];
/**
 ...
 */
exports.rule = {
    meta: (0, helpers_1.generateMeta)(meta_1.meta, { ...preferOptionalChainRule.meta }),
    create(context) {
