...
exports.rule = {
    ...
    create(context) {
        ...
        function checkCallToVerify(callExpression, publicKey, thirdArgumentValue, secondaryLocations) {
            const algorithmsProperty = (0, helpers_1.getProperty)(thirdArgumentValue, 'algorithms', context);
        ...
        function raiseIssueOn(node, message, secondaryLocations) {
            (0, helpers_1.report)(context, {
                node,
                message,
            }, secondaryLocations.map(node => (0, helpers_1.toSecondaryLocation)(node, SECONDARY_MESSAGE)));
        }
        return {
            CallExpression: (node) => {
