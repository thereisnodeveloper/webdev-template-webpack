        ...
        return {
            ...
            AssignmentExpression(node) {
                ...
                if (left.type === 'MemberExpression') {
                    ...
                    if ((0, helpers_1.isIdentifier)(object, 'document') && (0, helpers_1.isIdentifier)(property, 'cookie')) {
                        context.report({
            ...
            CallExpression(node) {
                ...
                if (callee.type === 'MemberExpression' &&
                    ...
                    (0, helpers_1.isIdentifier)(callee.property, 'cookie', 'cookies')) {
                    context.report({
                        messageId: 'safeCookie',
                        node,
                    });
                ...
                if (callee.type === 'MemberExpression' &&
                    (0, helpers_1.isIdentifier)(callee.property, 'setHeader') &&
