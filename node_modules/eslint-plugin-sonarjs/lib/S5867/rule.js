        ...
        onRegExpLiteralLeave: (regexp) => {
            if (!isUnicodeEnabled && (unicodeProperties.length > 0 || unicodeCharacters.length > 0)) {
                ...
                unicodeProperties.forEach(p => {
                    const loc = (0, regex_1.getRegexpLocation)(context.node, p.character, context, [0, p.offset]);
                    if (loc) {
                        secondaryLocations.push((0, helpers_1.toSecondaryLocation)({ loc }, 'Unicode property'));
                    }
                });
                unicodeCharacters.forEach(c => {
                    const loc = (0, regex_1.getRegexpLocation)(context.node, c, context);
                    if (loc) {
                        secondaryLocations.push((0, helpers_1.toSecondaryLocation)({ loc }, 'Unicode character'));
                    }
                });
