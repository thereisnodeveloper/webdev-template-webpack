...
exports.rule = helpers_1.Express.SensitiveMiddlewarePropertyRule(findNoReferrerPolicyPropertyFromHelmet, `Make sure disabling strict HTTP no-referrer policy is safe here.`, (0, helpers_1.generateMeta)(meta_1.meta, undefined, true));
function findNoReferrerPolicyPropertyFromHelmet(context, node) {
    ...
    if (args.length === 1) {
        ...
        if (fqn === HELMET && options.type === 'ObjectExpression') {
            ...
            const maybePolicy = (0, helpers_1.getProperty)(options, POLICY, context);
