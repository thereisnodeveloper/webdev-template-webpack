        ...
        function checkConcatenation(left, right) {
            ...
            if (isStringPlusNonString(leftType, rightType) ||
                ...
                (0, helpers_1.report)(context, {
                    ...
                    (0, helpers_1.toSecondaryLocation)(left, `left operand has type ${checker.typeToString(leftType)}.`),
                    (0, helpers_1.toSecondaryLocation)(right, `right operand has type ${checker.typeToString(rightType)}.`),
                ]);
            }
        }
        return {
