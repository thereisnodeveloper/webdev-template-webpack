...
exports.rule = {
    ...
    create(context) {
        function checkNodemailer(callExpression) {
            ...
            const ses = (0, helpers_1.getProperty)(firstArgValue, 'SES', context);
            if (ses && usesSesCommunication(ses)) {
                return;
            }
            const secure = (0, helpers_1.getProperty)(firstArgValue, 'secure', context);
            if (secure && (secure.value.type !== 'Literal' || secure.value.raw !== 'false')) {
                return;
            }
            const requireTls = (0, helpers_1.getProperty)(firstArgValue, 'requireTLS', context);
            if (requireTls && (requireTls.value.type !== 'Literal' || requireTls.value.raw !== 'false')) {
                return;
            }
            const port = (0, helpers_1.getProperty)(firstArgValue, 'port', context);
        ...
        function usesSesCommunication(sesProperty) {
            ...
            const ses = (0, helpers_1.getValueOfExpression)(context, (0, helpers_1.getProperty)(configuration, 'ses', context)?.value, 'NewExpression');
            if (!ses || (0, cdk_1.normalizeFQN)((0, helpers_1.getFullyQualifiedName)(context, ses)) !== '@aws_sdk.client_ses.SES') {
                return false;
            }
            const aws = (0, helpers_1.getProperty)(configuration, 'aws', context);
            if (!aws ||
