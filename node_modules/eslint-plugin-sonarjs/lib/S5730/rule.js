...
exports.rule = helpers_1.Express.SensitiveMiddlewarePropertyRule(findDirectivesWithMissingMixedContentPropertyFromHelmet, `Make sure allowing mixed-content is safe here.`, (0, helpers_1.generateMeta)(meta_1.meta, undefined, true));
...
function isMissingMixedContentProperty(directives, context) {
    return !(Boolean((0, helpers_1.getProperty)(directives.value, BLOCK_ALL_MIXED_CONTENT_CAMEL, context)) ||
        Boolean((0, helpers_1.getProperty)(directives.value, BLOCK_ALL_MIXED_CONTENT_HYPHEN, context)));
}
