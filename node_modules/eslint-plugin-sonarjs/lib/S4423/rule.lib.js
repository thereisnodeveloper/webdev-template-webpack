...
exports.rule = {
    ...
    create(context) {
        function getValueOfProperty(objectExpression, propertyName) {
            const unsafeProperty = objectExpression && (0, helpers_1.getProperty)(objectExpression, propertyName, context);
            if (unsafeProperty) {
        ...
        function checkSslOptions(optionsNode) {
            ...
            const secureOptions = (0, helpers_1.getProperty)(options, 'secureOptions', context);
