...
exports.rule = (0, iam_1.AwsIamPolicyTemplate)(privilegeEscalationStatementChecker, (0, helpers_1.generateMeta)(meta_1.meta, undefined, true));
function privilegeEscalationStatementChecker(expr, ctx, options) {
    ...
    if (!hasExceptionProperties(properties, options) &&
        ...
        (0, helpers_1.report)(ctx, {
            ...
            node: resource,
        }, [(0, helpers_1.toSecondaryLocation)(action, MESSAGES.secondary)]);
    }
}
