...
exports.rule = (0, iam_1.AwsIamPolicyTemplate)(allResourcesAccessibleStatementCheck, (0, helpers_1.generateMeta)(meta_1.meta, undefined, true));
function allResourcesAccessibleStatementCheck(expr, ctx, options) {
    ...
    if (effect.isMissing && resource) {
        ...
        (0, helpers_1.report)(ctx, {
            message: MESSAGES.message,
            node: resource,
        }, [(0, helpers_1.toSecondaryLocation)(effect.node, MESSAGES.secondary)]);
    }
}
