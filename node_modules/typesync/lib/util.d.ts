 ...
 * @param source
 */
export declare function shrinkObject<T extends object>(source: T): Required<T>;
/**
 ...
 * @param source
 */
export declare function orderObject<T extends Record<string | number | symbol, U>, U>(source: T, comparer?: (a: string, b: string) => number): T;
/**
 * Async memoize.
 *
 * @param fn
 */
export declare function memoizeAsync<U extends Array<W>, V, W>(fn: (...args: U) => Promise<V>): (...args: U) => Promise<V>;
/**
 * Ensures that we have a valid workspaces array.
 *
 * @param data
 */
export declare function ensureWorkspacesArray(data?: IWorkspacesSection): IWorkspacesArray;
